...
const HandicappedCare = () => {
  const { t } = useLanguage();

  const features = [
    t('handicappedFeature1'),
    t('handicappedFeature2'),
    t('handicappedFeature3'),
    t('handicappedFeature4'),
    t('handicappedFeature5'),
  ];
...
export default HandicappedCare;
